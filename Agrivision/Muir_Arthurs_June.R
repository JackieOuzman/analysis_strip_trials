...
#file://Fssa2-adl/clw-share1/Microlab/value_soil_testing_prj/Yield_data/Agrivision/Craig_Muir_1/Postlethwaite/Arthurs/output/Arthurs_Yld_SegID_Zone.csv

#As it appears in the database
Organisation_db	  = "Agrivision"
Contact_db = "Craig_Muir_1"
Farmer_db  =  "Postlethwaite"
Paddock_tested_db  =	"Arthurs"
#Zone_db            = 
data_file       = "Arthurs_Yld_SegID_Zone.csv"
...
long_name <-  data.frame( rate_name = c("Grower_rate" , "rate1",  "rate2", "rate3"), 
                          Details = c("MAP 40 + Urea 90 (kg Fert)",
                                      "MAP 0 + Urea 90 (kg Fert)", 
                                      "MAP 20 + Urea 90 (kg Fert)",
                                      "MAP 80 + Urea 90 (kg Fert)"), 
                          Starter_Feriliser = "TBC",
                          Topdress = "Urea 60 Kg Fert")

Starter_Feriliser <- "TBC"
Topdress <-  "Urea 60 Kg Fert 09/08/2019"
...
print(Rates_labels)
Grower_rate_label <- paste0("Grower rate = ", "40", " (", "MAP 40 + Urea 90 (kg Fert)", ")")
