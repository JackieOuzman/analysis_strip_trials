...
#file://Fssa2-adl/clw-share1/Microlab/value_soil_testing_prj/Yield_data/Agrivision/Craig_Muir_1/Parsons/Dunns/output/Dunns_Yld_Seg_ID_zone.csv

#As it appears in the database
Organisation_db	  = "Agrivision"
Contact_db = "Craig_Muir_1"
Farmer_db  =  "Parsons"
Paddock_tested_db  =	"Dunns"
#Zone_db            = 
data_file       = "Dunns_Yld_Seg_ID_zone.csv"
...
long_name <-  data.frame( rate_name = c("Grower_rate" , "rate1",  "rate2", "rate3"), 
                          Details = c("MESZ 50 + Urea 45 (kg Fert)",
                                      "MESZ 0 + Urea 45 (kg Fert)", 
                                      "MESZ 25 + Urea 45 (kg Fert)",
                                      "MESZ 100 + Urea 45 (kg Fert)"), 
                          Starter_Feriliser = "TBC",
                          Topdress = "Urea 75 Kg Fert")

Starter_Feriliser <- "TBC"
Topdress <-  "Urea 75 Kg Fert 28/06/2019"
...
print(Rates_labels)
Grower_rate_label <- paste0("Grower rate = ", "50", " (", "MESZ 50 + Urea 45 (kg Fert)", ")")
