...
#file://Fssa2-adl/clw-share1/Microlab/value_soil_testing_prj/Yield_data/Landmark/Tom_Cooper_9/A_P_Robertson_1/Bird/output/Bird_Yld_SegID_Zone.csv

#As it appears in the database
Organisation_db	  = "Landmark"
Contact_db = "Tom_Cooper_9"
Farmer_db  =  "A_P_Robertson_1"
Paddock_tested_db  =	"Bird"
#Zone_db            = 
data_file       = "Bird_Yld_SegID_Zone.csv"
