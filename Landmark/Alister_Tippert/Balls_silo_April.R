...
#\\Fssa2-adl\clw-share1\Microlab\value_soil_testing_prj\Yield_data\Landmark\Alister_Tippert_1\Chris_Shark_4\Balls_Silo_1\output

#As it appears in the database
Organisation_db	  = "Landmark"
Contact_db = "Alister_Tippert_1"
Farmer_db  =  "Chris_Shark_4"
Paddock_tested_db  =	"Balls_Silo_1"
#Zone_db            = 
data_file       = "BallsSilo1_Yld_SegID_Zones.csv"
...
Fert_legend_name <- "Fetiliser Rates"
...
segments <- ggplot(seg_ID_t_test_summary, aes(SegmentID , Yld, group = Rate_as_factor))+
  ...
  annotate("text", x = 80, y= 2,label = "Some missing data")
