...
#\\Fssa2-adl\clw-share1\Microlab\value_soil_testing_prj\Yield_data\Landmark\Andrew_McMahen_8\Birkinshaw_1\Round_Home\output

#As it appears in the database
Organisation_db	  = "Landmark"
Contact_db = "Andrew_McMahen_8"
Farmer_db  =  "Birkinshaw_1"
Paddock_tested_db  =	"Round_Home"
#Zone_db            = 
data_file       = "RoundHome_Yld_SegID_Zone.csv"
...
annotate("text", x = 600, y= 3,label = "Some missing data")
