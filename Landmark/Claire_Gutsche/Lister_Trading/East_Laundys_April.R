...
#file://Fssa2-adl/clw-share1/Microlab/value_soil_testing_prj/Yield_data/Landmark/Claire_Gutsche_6/Lister_Trading_1/East_Laundys/processing/East_Laudys_Yld_SegID_zone.csv
"W:\value_soil_testing_prj\Yield_data\Landmark\Claire_Gutsche_6\Lister_Trading_1\East_Laundys\output\EastLaundys_Yld_SegID_zone.csv"

#As it appears in the database
Organisation_db	  = "Landmark"
Contact_db = "Claire_Gutsche_6"
Farmer_db  =  "Lister_Trading_1"
Paddock_tested_db  =	"East_Laundys"
#Zone_db            = 
data_file       = "EastLaundys_Yld_SegID_zone.csv"
...
seg_ID <-  dplyr::select(seg_ID, - Strip_Rate)
seg_ID <-seg_ID %>% 
