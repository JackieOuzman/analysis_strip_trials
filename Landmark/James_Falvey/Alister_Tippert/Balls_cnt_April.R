...
#\\Fssa2-adl\clw-share1\Microlab\value_soil_testing_prj\Yield_data\Landmark\Alister_Tippert_1\Chris_Shark_4\Balls_Centre_2\output
...
Paddock_tested_db  =	"Balls_Centre_2"
#Zone_db            = 
data_file       = "BallsCentre2_Yld_SegID_Zone.csv"
