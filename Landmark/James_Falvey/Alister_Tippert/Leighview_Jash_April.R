...
#"W:\value_soil_testing_prj\Yield_data\Landmark\Alister_Tippert_1\Leighview_2\Jash_5\output\Jash5_Yld_SegID_Zone.csv"


#As it appears in the database
Organisation_db	  = "Landmark"
Contact_db = "Alister_Tippert_1"
Farmer_db  =  "Leighview_2"
Paddock_tested_db  =	"Jash_5"
#Zone_db            = 
data_file       = "Jash5_Yld_SegID_Zone.csv"
