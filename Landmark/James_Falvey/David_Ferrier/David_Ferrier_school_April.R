...
#"W:\value_soil_testing_prj\Yield_data\Landmark\James_Falvey_2\David_Ferrier\School\output\School_Yld_SegID_Zone.csv"

#As it appears in the database
Organisation_db	  = "Landmark"
Contact_db = "James_Falvey_2"
Farmer_db  =  "David_Ferrier"
Paddock_tested_db  =	"School"
#Zone_db            = 
data_file       = "School_Yld_SegID_Zone.csv"
