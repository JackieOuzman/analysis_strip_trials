...
#\\Fssa2-adl\clw-share1\Microlab\value_soil_testing_prj\Yield_data\Landmark\James_Falvey_2\Lehmann_3\Back\output\Back_Yld_SegID_Zone.csv

#As it appears in the database
Organisation_db	  = "Landmark"
Contact_db = "James_Falvey_2"
Farmer_db  =  "Lehmann_3"
Paddock_tested_db  =	"Back"
#Zone_db            = 
data_file       = "Back_Yld_SegID_Zone.csv"
