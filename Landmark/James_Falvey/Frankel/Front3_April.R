...
#\\Fssa2-adl\clw-share1\Microlab\value_soil_testing_prj\Yield_data\Landmark\James_Falvey_2\Frankel_2\Front_3\output\Front3_Yld_SegID_Zone.csv

#As it appears in the database
Organisation_db	  = "Landmark"
Contact_db = "James_Falvey_2"
Farmer_db  =  "Frankel_2"
Paddock_tested_db  =	"Front_3"
#Zone_db            = 
data_file       = "Front3_Yld_SegID_Zone.csv"
...
annotate("text", x = 1000, y= 1,label = "Some missing data")
