...
#"file://Fssa2-adl/clw-share1/Microlab/value_soil_testing_prj/Yield_data/Landmark/James_Falvey_2/Tim_McClelland_4/Top/output/Top_Yld_SegID_Zone.csv

#As it appears in the database
Organisation_db	  = "Landmark"
Contact_db = "James_Falvey_2"
Farmer_db  =  "Tim_McClelland_4"
Paddock_tested_db  =	"Top"
#Zone_db            = 
data_file       = "Top_Yld_SegID_Zone.csv"
