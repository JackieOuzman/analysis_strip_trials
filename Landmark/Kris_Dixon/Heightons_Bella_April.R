...
#\\Fssa2-adl\clw-share1\Microlab\value_soil_testing_prj\Yield_data\Landmark\Kris_Dixon_6\Heightons_1\Bellas\output

#As it appears in the database
Organisation_db	  = "Landmark"
Contact_db = "Kris_Dixon_6"
Farmer_db  =  "Heightons_1"
Paddock_tested_db  =	"Bellas"
#Zone_db            = 
data_file       = "Bella_Yld_SegID_Zone.csv"
...
segments <- ggplot(seg_ID_t_test_summary, aes(SegmentID , Yld, group = Rate_as_factor))+
  ...
  annotate("rect", xmin =zone2_min , xmax = zone2_max, ymin = 0, ymax = 8, #zone 2
           alpha = .2)+
  annotate("rect", xmin =10 , xmax = 650, ymin = 0, ymax = 8, #zone 2
           alpha = .1, colour = "blue")+
...
annotate("text", x = 250, y= 7,label = "Western Strip", colour = "red")
