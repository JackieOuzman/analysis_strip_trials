...
"\\FSSA2-ADL\clw-share1\Microlab\value_soil_testing_prj\Yield_data\Landmark\Kris_Dixon_6\Heightons_1\McKenzie\output\McKenzie_Yld_SegID_Zone.csv"

#As it appears in the database
Organisation_db	  = "Landmark"
Contact_db = "Kris_Dixon_6"
Farmer_db  =  "Heightons_1"
Paddock_tested_db  =	"McKenzie"
#Zone_db            = 
data_file       = "McKenzie_Yld_SegID_Zone.csv"
...
annotate("text", x = 174, y= 3.5,label = "North Strip", colour = "red")
