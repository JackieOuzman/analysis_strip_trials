...
#\\Fssa2-adl\clw-share1\Microlab\value_soil_testing_prj\Yield_data\Landmark\Matt_Nihill_7\GRG_Weeks_1\Reids_mount\output

#As it appears in the database
Organisation_db	  = "Landmark"
Contact_db = "Matt_Nihill_7"
Farmer_db  =  "GRG_Weeks_1"
Paddock_tested_db  =	"Reids_mount"
#Zone_db            = 
