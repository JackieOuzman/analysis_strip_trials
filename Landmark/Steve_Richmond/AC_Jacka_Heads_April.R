...
libs <- c("dplyr", "tidyr", 
          ...
          "RGraphics", 
          "gridExtra", "rdrop2", "readr", "stringr")
...
#file://Fssa2-adl/clw-share1/Microlab/value_soil_testing_prj/Yield_data/Landmark/Steve_Richmond_5/AC_Jacka_2/Heads/output/Heads_Yld_SegID_Zone.csv
...
Paddock_tested_db  =	"Heads"
#Zone_db            = 
data_file       = "Heads_Yld_SegID_Zone.csv"
