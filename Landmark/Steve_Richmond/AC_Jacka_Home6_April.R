...
#"\\FSSA2-ADL\clw-share1\Microlab\value_soil_testing_prj\Yield_data\Landmark\Steve_Richmond_5\AC_Jacka_2\Home_6\output\Home06_Yld_SegID_Zone.csv"


#As it appears in the database
Organisation_db	  = "Landmark"
Contact_db = "Steve_Richmond_5"
Farmer_db  =  "AC_Jacka_2"
Paddock_tested_db  =	"Home_6"
#Zone_db            = 
data_file       = "Home06_Yld_SegID_Zone.csv"
...
zone_av_1_rate3vsGR_res_sig
 ...
 zone_1 <- ggplot( zone_av_1, aes(Rate_as_factor, Yld))+
   ...
   annotate("text", x = 3, y= 0, size = 3,label = "box plot = 25%, 50%, 75%, dashed line = mean")
 zone_1
