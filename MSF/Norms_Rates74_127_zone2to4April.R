...
Farmer_db  =  "Pole"
Paddock_tested_db  =	"Norms"
#Zone_db            = 
data_file       = "Norms_Yld_SegID_zone.csv"
...
name_sub <- "1b Rate 74 to 127 and zone 2 to 4"
seg_ID <- filter(seg_ID,
                 Rates != 0 & Rates != 52)
unique(seg_ID$Rates)
...
ggsave(path= graph_path, filename = paste0("t-test_segments_", name_sub, ".png"), device = "png" ,
       width = 20, height = 10, units = "cm")

seg_ID_t_test_summary <- left_join(seg_ID_t_test_summary,list_rates)

write.csv(seg_ID_t_test_summary, paste0(graph_path,"/t_test_segments_", name_sub, ".csv"))
...
zone_av_1_rate3vsGR_res_sig
 ...
 ggsave(path= graph_path, filename = paste0("t-test_zone_zone1_strip_", name_sub, ".png"), device = "png" ,
        width = 20, height = 10, units = "cm")
 ...
 write.csv(zone_av_1, paste0(graph_path,"/t_testzone_zone1_av_", name_sub, ".csv"))
 ...
 ggsave(path= graph_path, 
        filename = paste0("t-test_zone_zone2_strip_", name_sub, ".png"), device = "png" ,
        width = 20, height = 10, units = "cm")
 ...
 mean_zone_av_2
 write.csv(zone_av_2, paste0(graph_path,"/t_testzone_zone2_av_", name_sub, ".csv"))
 ...
 ##save the graphs of the zone strip work
 ggsave(path= graph_path, 
        paste0(filename = "t-test_zone_zone3_strip", name_sub, ".png"), 
        device = "png" ,
        width = 20, height = 10, units = "cm")
 ...
 write.csv(zone_av_3, paste0(graph_path,"/t_testzone_zone3_av_", name_sub, ".csv"))
...
ggsave(path= graph_path, 
       filename = paste0(paddock, "_collection_", name_sub, ".png"), 
       device = "png", 
