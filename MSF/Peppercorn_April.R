...
#file://Fssa2-adl/clw-share1/Microlab/value_soil_testing_prj/Yield_data/MSF/Michael_Moodie_Todd_McDonald/Anderson/Peppercorn/processing/peppercorns_yld_seg_ID_zone.csv

#As it appears in the database
Organisation_db	  = "MSF"
Contact_db = "Michael_Moodie_Todd_McDonald"
Farmer_db  =  "Anderson"
Paddock_tested_db  =	"Peppercorn"
#Zone_db            = 
data_file       = "peppercorns_yld_seg_ID_zone.csv"
...
table1
paddock
collection <- grid.arrange(zone_2, zone_3,zone_1, table2, table1, segments, nrow = 5,  ncol=3, 
