...
#"W:\value_soil_testing_prj\Yield_data\MSF\Michael_Moodie_Todd_McDonald\Hunt\Pirlta\processing\Pirtla_Yld_SegID_zone.csv"
#As it appears in the database
Organisation_db	  = "MSF"
Contact_db = "Michael_Moodie_Todd_McDonald"
Farmer_db  =  "Hunt"
Paddock_tested_db  =	"Pirlta"
#Zone_db            = 
data_file       = "Pirtla_Yld_SegID_zone2.csv"
...
seg_ID <- dplyr::filter(seg_ID, !between(seg_ID$SegmentID, 191, 193))
seg_ID <- dplyr::filter(seg_ID, SegmentID != 290)
seg_ID <- dplyr::filter(seg_ID, SegmentID != 1260)
...
list_SegmentID_values <- seg_ID_rate1vsGR$SegmentID[duplicated(seg_ID_rate1vsGR$SegmentID)] #this returns a list of values I want to keep
seg_ID_rate1vsGR <- seg_ID_rate1vsGR %>% filter(SegmentID %in% list_SegmentID_values)

list_SegmentID_values <- seg_ID_rate2vsGR$SegmentID[duplicated(seg_ID_rate2vsGR$SegmentID)] #this returns a list of values I want to keep
seg_ID_rate2vsGR <- seg_ID_rate2vsGR %>% filter(SegmentID %in% list_SegmentID_values)

list_SegmentID_values <- seg_ID_rate3vsGR$SegmentID[duplicated(seg_ID_rate3vsGR$SegmentID)] #this returns a list of values I want to keep
seg_ID_rate3vsGR <- seg_ID_rate3vsGR %>% filter(SegmentID %in% list_SegmentID_values)
