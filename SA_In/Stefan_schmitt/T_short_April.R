...
#file://Fssa2-adl/clw-share1/Microlab/value_soil_testing_prj/Yield_data/SA_Ind/Stefan_Schmitt/T_Short/TomShort/output/TomShort_Yld_SegID_Zone.csv

#As it appears in the database
Organisation_db	  = "SA_Ind"
Contact_db = "Stefan_Schmitt"
Farmer_db  =  "T_Short"
Paddock_tested_db  =	"Red Good and Grey Not Good"
#Zone_db            = 
data_file       = "TomShort_Yld_SegID_Zone.csv"
