...
#file://Fssa2-adl/clw-share1/Microlab/value_soil_testing_prj/Yield_data/Vic_Ind/Anne_Jackman_3/Chamberlain_2/output/Chamberlain2_N_Yld_SegID_Zone.csv


#As it appears in the database
Organisation_db	  = "Vic_Ind"
Contact_db = "Anne_Jackman_3"
Farmer_db  =  "Chamberlain_2"
Paddock_tested_db  =""	
Paddock_tested_db_1  =  ""
#Zone_db            = 
data_file       = "Chamberlain2_N_Yld_SegID_Zone.csv"
...
seg_ID <- dplyr:: select(seg_ID, - "P_Rate")

seg_ID <-seg_ID %>% 
  rename_at(vars(contains("Rate")), ~"Rates") %>% 
...
ggsave(path= graph_path, filename = paste0("t-test_segments", append_analysis_type, ".png"), device = "png" ,
       width = 20, height = 10, units = "cm")


seg_ID_t_test_summary <- left_join(seg_ID_t_test_summary,list_rates)

write.csv(seg_ID_t_test_summary, paste0(graph_path,"/t_test_segments" , append_analysis_type, ".csv"))
...
zone_av_1_rate3vsGR_res_sig
 ...
 ggsave(path= graph_path, filename = paste0("t-test_zone_zone1_strip",
        append_analysis_type,
        ".png"), device = "png" ,
        width = 20, height = 10, units = "cm")
 ...
 write.csv(zone_av_1, paste0(graph_path,"/t_testzone_zone1_av", append_analysis_type, ".csv"))
 ...
 ##save the graphs of the zone strip work
 ggsave(path= graph_path, filename = paste0("t-test_zone_zone2_strip"
        , append_analysis_type,
        ".png"), device = "png" ,
        width = 20, height = 10, units = "cm")
 ...
 mean_zone_av_2
 write.csv(zone_av_2, paste0(graph_path,"/t_testzone_zone2_av", append_analysis_type, ".csv"))
 ...
 ##save the graphs of the zone strip work
 ggsave(path= graph_path, filename = "t-test_zone_zone3_strip", 
 append_analysis_type, ".png", device = "png" ,
        width = 20, height = 10, units = "cm")
 ...
 write.csv(zone_av_3, paste0(graph_path,"/t_testzone_zone3_av", append_analysis_type, ".csv"))
...
ggsave(path= graph_path, filename = paste0(paddock, "_collection", 
                                           append_analysis_type, 
                                           ".png"), device = "png", 
