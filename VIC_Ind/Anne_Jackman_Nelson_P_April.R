...
#file://Fssa2-adl/clw-share1/Microlab/value_soil_testing_prj/Yield_data/Vic_Ind/Anne_Jackman_3/Nelson_3/output/Nelson3_N_Yld_SegID_Zone.csv
...
Farmer_db  =  "Nelson_3"
Paddock_tested_db  =""	
Paddock_tested_db_1  =  "loamy sand and loam"
#Zone_db            = 
data_file       = "Nelson3_P_Yld_SegID_Zone.csv"
...
seg_ID <-seg_ID %>% 
  ...
  rename_at(vars(contains("Rates_MESZ")), ~"Rates") %>% 
