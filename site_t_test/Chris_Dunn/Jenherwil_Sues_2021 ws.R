...
collection1
ggsave( filename = 
          "W:/value_soil_testing_prj/Yield_data/2020/processing/r_outputs/ws_plots_etc/Jenharwil_sues_N.png",
...
GR_vs_low_High_rate <- GR_vs_low_High_rate %>%
  filter(Rate == c(60,120)) # this is what we will keep 2.5,17.9
