...
rate_order_all <- rbind(rate_order_zone_1, rate_order_zone_2 , rate_order_zone_3)
...
GSP_low_vs_high_all <- rbind(GSP_low_vs_highzone_1, GSP_low_vs_highzone_2 , GSP_low_vs_highzone_3) 
