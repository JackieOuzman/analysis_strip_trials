...
zone_1_filter <- recom_rate1 %>% 
  filter(Rate %in% c(36,73,145) & zone_name == "zone1") #what is in the bracket we will keep
zone_2_filter <- recom_rate1 %>% 
  filter(Rate %in% c(36,73,145) & zone_name == "zone2")
zone_3_filter <- recom_rate1 %>% 
  filter(Rate %in% c(0,36,73) & zone_name == "zone3")
