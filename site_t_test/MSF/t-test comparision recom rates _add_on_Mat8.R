...
recom_rate1_summary <- rbind(recom_rate1_summary_zone1, recom_rate1_summary_zone2, recom_rate1_summary_zone3)
...
zone_1_filter <- recom_rate1 %>% 
  filter(Rate %in% c(0,30,60) & zone_name == "zone1") #what is in the bracket we will keep
zone_2_filter <- recom_rate1 %>% 
  filter(Rate %in% c(30,60,90) & zone_name == "zone2")
zone_3_filter <- recom_rate1 %>% 
  filter(Rate %in% c(0,30,60) & zone_name == "zone3")


recom_rate1 <- rbind(zone_1_filter, zone_2_filter, zone_3_filter)
