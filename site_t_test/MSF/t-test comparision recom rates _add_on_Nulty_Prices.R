...
zone_1_filter <- recom_rate1 %>% 
  filter(Rate %in% c(25,50,75) & zone_name == "zone1") #what is in the bracket we will keep
zone_2_filter <- recom_rate1 %>% 
  filter(Rate %in% c(0,25,50) & zone_name == "zone2")
zone_3_filter <- recom_rate1 %>% 
  filter(Rate %in% c(0,25,50) & zone_name == "zone3")
