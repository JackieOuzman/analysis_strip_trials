...
input_file <-"BackKitto_Yld_SegID_zone.csv"
name_Paddock <- unlist(strsplit(input_file,"_"))[1]
## add this into the strips df
name_Paddock <- "Limevale - Back Kitto"
name_Paddock
...
### some of the clms are not named the same as the other files.
names(strips) # eg NUMPOINTS

strips <- rename(strips, PtCount = NUMPOINTS)
